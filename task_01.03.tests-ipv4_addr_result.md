...
```
nodes = [<riotctrl.ctrl.RIOTCtrl object at 0x7fdf6a4561c0>], log_nodes = True, riotbase = '/home/mlenders/Repositories/RIOT-OS/RIOT'
test_suite = 'tests-ipv4_addr'
...
popenargs = (['make', '--no-print-directory', '-C', '/home/mlenders/Repositories/RIOT-OS/RIOT/tests/unittests', 'tests-ipv4_addr', 'flash-only', ...],)
...
E               subprocess.CalledProcessError: Command '['make', '--no-print-directory', '-C', '/home/mlenders/Repositories/RIOT-OS/RIOT/tests/unittests', 'tests-ipv4_addr', 'flash-only', 'test']' returned non-zero exit status 2.
